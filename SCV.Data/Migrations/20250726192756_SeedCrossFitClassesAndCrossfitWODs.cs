    ...
    public partial class SeedCrossFitClassesAndCrossfitWODs : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "ApplicationUserId", "DayOfWeek", "Description", "Name", "StartTime", "TrainerName" },
                values: new object[,]
                {
                    { new Guid("43c892c1-6fd9-409e-82e8-4b38eedcbed5"), null, 2, "Enhance flexibility and mobility to improve overall performance.", "CrossFit Mobility", "Tuesday at 18:00", "Maya Ivanova" },
                    { new Guid("55ea312a-2607-432a-beaa-88cdae84261d"), null, 2, "Cardio-focused CrossFit session to build stamina and VO2 max.", "CrossFit Endurance", "Tuesday at 19:00", "Ivan Dimitrov" },
                    { new Guid("621d28e0-4142-4ba6-a754-a0f3537548e3"), null, 1, "Focus on building strength with heavy lifts and compound movements.", "CrossFit Strength", "Monday at 19:00", "Georgi Kolev" },
                    { new Guid("6b0d85a4-6707-4c9b-8759-132ec7512afe"), null, 6, "Classes teaching technique and power development in snatch and clean and jerk.", "CrossFit Olympic Lifting", "Saturday at 17:00", "Guest Coach: Tsvetan Nikolov" },
                    { new Guid("7724554f-7f07-49f5-a7e2-5cc81e77a81a"), null, 3, "Team-based workout to build camaraderie and competitive spirit.", "CrossFit Team Challenge", "Wednesday at 17:00", "Georgi Kolev" },
                    { new Guid("7aa86503-08e5-4d0f-a76e-331652c9235b"), null, 1, "A high-intensity Hero WOD designed to test endurance and mental toughness.", "WOD: Hero Workout", "Monday at 17:00", "Ivan Dimitrov" },
                    { new Guid("a67e482d-ede8-491b-8f71-eeb4b3ecefbc"), null, 5, "Introduction to CrossFit movements and techniques for beginners.", "CrossFit Basics", "Friday at 18:00", "Maya Ivanova" },
                    { new Guid("c33e1e9d-1a72-47d5-8e53-8ed00d668785"), null, 6, "Specialized training session to prepare for the CrossFit Open competition.", "CrossFit Open Prep", "Saturday at 10:00", "Guest Coach: Stoyan Dimitrov" }
                });
