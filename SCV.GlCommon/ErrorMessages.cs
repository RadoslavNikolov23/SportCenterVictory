namespace SCV.GlCommon
{
    public static class ErrorMessages
    {
        ...
        public const string MembershipsNotFound = "No memberships found for {0}.";

        public const string TrainersNotFound = "No trainers found for {0}.";

        public const string EventsNotFound = "No events found for {0}.";
