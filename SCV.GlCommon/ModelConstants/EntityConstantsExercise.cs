namespace SCV.GlCommon.ModelConstants
{
    public static class EntityConstantsExercise
    {
        ...
        public const int PrimaryMusclesMinLength = 3;

        public const int SecondaryMusclesMaxLength = 255;
        ...
        public const int ImageUrlOneMinLength = 5;

        public const int ImageUrlTwoMaxLength = 2048;
        public const int ImageUrlTwoMinLength = 5;
