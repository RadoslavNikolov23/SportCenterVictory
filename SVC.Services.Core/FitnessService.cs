namespace SVC.Services.Core
{
    ...
    {
        public IEnumerable<ExercisesViewModel>? GetAllExercises()
        {
            ...
            string filePath = Path.Combine(rootPath, "wwwroot", "data", "allExercisesSeed.json");

            // Read the file content
            string jsonFile = System.IO.File.ReadAllText(filePath);


            IEnumerable<ExercisesViewModel>? exercisesList = JsonConvert
                 .DeserializeObject<List<ExercisesViewModel>>(jsonFile);
