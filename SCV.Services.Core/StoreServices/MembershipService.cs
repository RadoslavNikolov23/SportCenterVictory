namespace SCV.Services.Core.StoreServices
{
    ...
    public class MembershipService : IMembershipService
    {
        ...
        {
            IEnumerable<MembershipDetailViewModel> allMembershipsViewModels = await membershipRepo
                                    .GetAllAttached()
                                    .AsNoTracking()
        ...
        public async Task<IEnumerable<MembershipDetailViewModel>> GetAllMembershipPerSportAsync(SportType membershipType)
        {
            ...
            membershipsCollection = await membershipRepo
                        .GetAllAttached()
                        .AsNoTracking()
        ...
        public async Task<bool> AddMembershipAsync(MembershipAddViewModel membershipAddVM)
        {
            ...
            if (membershipAddVM != null)
            {
                ...
                await membershipRepo.AddAsync(membershipToAdd);
                isAdded = true;
            }
        ...
        public async Task<MembershipEditViewModel?> GetMembershipByIdAsync(string? id)
        {
            ...
            {
                Membership? membershipEntity = await membershipRepo
                            .GetAllAttached()
        ...
        {
            IEnumerable<MembershipDeleteViewModel> listMembershipsDeleteVM = await membershipRepo
                                                    .GetAllAttached()
                                                    .IgnoreQueryFilters()
