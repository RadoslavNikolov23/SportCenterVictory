namespace SCV.Services.Core.FitnessServices
{
    ...
    public class WorkoutPlanExerciseService : IWorkoutPlanExerciseService
    {
        ...
        {
            return await workoutPlanExerciseRepo
                        .GetAllAttached()
        ...
        public async Task UpdateExercisesForWorkoutPlanAsync(string workoutPlanId, ICollection<string> exerciseIds)
        {
            ...
            ICollection<WorkoutPlanExercise> existingLinks = await workoutPlanExerciseRepo
                .GetAllAttached()
            ...
            {
                await workoutPlanExerciseRepo.HardDeleteRangeAsync(existingLinks);
            }
            ...
            if (exerciseIds.Any())
            {
                ...
                await workoutPlanExerciseRepo.AddRangeAsync(newExercisesAttached);
            }
        }
    }
}
