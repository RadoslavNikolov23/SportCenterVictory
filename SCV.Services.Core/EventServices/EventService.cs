namespace SCV.Services.Core.EventServices
{
    ...
    public class EventService : IEventService
    {
        ...
        {
            IEnumerable<EventDetailViewModel> eventVM = await eventRepo
                            .GetAllAttached()
                            .AsNoTracking()
        ...
        {
            IEnumerable<EventAdminDetailViewModel> eventsAdminDetailVM = await eventRepo
                                                    .GetAllAttached()
                                                    .AsNoTracking()
                                                    .IgnoreQueryFilters()
        ...
        public async Task<bool> AddEventAsync(EventAddViewModel crossfitClassAddVM)
        {
            ...
            if (crossfitClassAddVM != null)
            {
                ...
                await eventRepo.AddAsync(eventToAdd);
                isAdded = true;
            }
        ...
        public async Task<EventEditViewModel?> GetEventByIdAsync(string? id)
        {
            ...
            {
                Event? eventEntity = await eventRepo
                            .GetAllAttached()
        ...
        {
            IEnumerable<EventDeleteViewModel> listEventsDeleteVM = await eventRepo
                                                    .GetAllAttached()
                                                    .IgnoreQueryFilters()
