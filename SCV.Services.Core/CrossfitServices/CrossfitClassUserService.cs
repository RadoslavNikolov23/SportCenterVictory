namespace SCV.Services.Core.CrossfitServices
{
    ...
    public class CrossfitClassUserService : ICrossfitClassUserService
    {
        ...
        {
            crossfitClassUserRepo = crossfitUserRepo;
        }
        ...
        public async Task<bool> AddUserToCrossfitClass(string? crossfitClassId, string userId)
        {
            ...
            if (crossfitClassId != null && userId != null)
            {
                ...
                {
                    CrossfitClassUser? crossfitClassUserEntity = await crossfitClassUserRepo
                        .GetAllAttached()
                        .IgnoreQueryFilters()
                    ...
                    if (crossfitClassUserEntity != null)
                    {
                        ...
                        result = await crossfitClassUserRepo
                    ...
                    else
                    {
                        ...
                        await crossfitClassUserRepo.AddAsync(crossfitClassUserEntity);
                        result = true;
                    }
                }
            }
        ...
        {
            IEnumerable<UserCrossfitClassesForAdminListViewModel> clientsCrossfitClassList = await crossfitClassUserRepo
                .GetAllAttached()
                .Include(ccu => ccu.ApplicationUser)
                .Include(ccu => ccu.CrossfitClass)
                .AsNoTracking()
