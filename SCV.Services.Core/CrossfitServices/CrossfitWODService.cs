namespace SCV.Services.Core.CrossfitServices
{
    ...
    public class CrossfitWODService : ICrossfitWODService
    {
        ...
        public async Task<CrossfitWODViewModel?> GetCrossfitWODByIdAsync(string id)
        {
            ...
            CrossfitWorkoutOfTheDay? crossfitWODEntity = await crossfitWODRepository
        ...
        public async Task<CrossfitWODViewModel?> GetLatestCrossfitWODAsync()
        {
            ...
            CrossfitWorkoutOfTheDay? entityCrossfitWOD = await crossfitWODRepository
                                                         .GetTodayWOD();
            ...
            if (entityCrossfitWOD == null)
            {
                ...
                if (entityCrossfitWOD != null)
                {
                    CrossfitWorkoutOfTheDay? wodExist = await crossfitWODRepository
                                       .GetAllAttached()
        ...
        {
            IEnumerable<CrossfitWODViewModel> allCrossfitWODViews = await crossfitWODRepository
                                            .GetAllAttached()
                                            .AsNoTracking()
