namespace SCV.Services.Core.TrainerServices
{
    ...
    public class TrainerService : ITrainerService
    {
        ...
        {
            IEnumerable<TrainerDetailViewModel> trainerVM = await trainerRepo
                                        .GetAllAttached()
                                        .AsNoTracking()
        ...
        {
            IEnumerable<TrainerAdminDetailViewModel> trainersAdminDetailVM = await userManager
                                                                .Users
                                                                .AsNoTracking()
        ...
        public async Task<bool> AddTrainerBioAsync(TrainerBioAddViewModel trainerBioToAddVM)
        {
            ...
            if (trainerBioToAddVM != null)
            {
                ...
                await trainerRepo.AddAsync(trainerToAdd);
        ...
        public async Task<TrainerBioEditViewModel?> GetTrainerBioByIdAsync(string? id)
        {
            ...
            {
                Trainer? trainerEntity = await trainerRepo
                    .GetAllAttached()
        ...
        {
            IEnumerable<TrainerBioDeleteViewModel> listTrainerBiosToDelete = await trainerRepo
                                        .GetAllAttached()
                                        .AsNoTracking()
                                        .IgnoreQueryFilters()
