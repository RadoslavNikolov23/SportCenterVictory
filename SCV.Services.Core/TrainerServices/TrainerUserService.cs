namespace SCV.Services.Core.TrainerServices
{
    ...
    public class TrainerUserService : ITrainerUserService
    {
        ...
        {
            IEnumerable<TrainerUserDetailViewModel> trainerUserList = await trainerUserRepo
                .GetAllAttached()
        ...
        {
            IEnumerable<TrainerClientListViewModel> clientsTrainerList = await trainerUserRepo
                .GetAllAttached()
        ...
        public async Task<bool> AddUserToTrainer(string? trainerId, string userId)
        {
            ...
            if (trainerId != null && userId != null)
            {
                ...
                {
                    TrainerUser? trainerUserEntity = await trainerUserRepo
                        .GetAllAttached()
                        .IgnoreQueryFilters()
                    ...
                    else
                    {
                        ...
                        await trainerUserRepo.AddAsync(trainerUserEntity);
                        result = true;
                    }
                }
            }
        ...
        public async Task<bool> RemoveTrainerFromUserAsync(string? trainerId, string? userId)
        {
            ...
            if (trainerId != null && userId != null)
            {
                ...
                if (isTrainerIdValid)
                {
                    TrainerUser? trainerUserEntry = await trainerUserRepo
                        .GetAllAttached()
                        .IgnoreQueryFilters()
                    ...
                    if (trainerUserEntry != null)
                    {
                        ...
                        result = await trainerUserRepo.DeleteAsync(trainerUserEntry);
                    }
                }
            }
        ...
        {
            IEnumerable<TrainerUserForAdminListViewModel> clientsTrainerList = await trainerUserRepo
                .GetAllAttached()
                .Include(tu => tu.ApplicationUser)
                .Include(tu => tu.Trainer)
                .AsNoTracking()
